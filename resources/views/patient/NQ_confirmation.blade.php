...
<div class="flex justify-between items-center max-w-7xl mx-auto px-8 py-5 flex justify-between items-center">
...
<p class="text-on-surface-variant text-sm font-medium uppercase tracking-widest mb-12">Normal Priority Queue</p>
<div class="relative inline-block mb-12">
<div class="bg-surface-container-low rounded-xl px-12 py-8 relative z-10">
<span class="block text-7xl md:text-8xl font-black text-primary tracking-tighter">N48</span>
</div>
