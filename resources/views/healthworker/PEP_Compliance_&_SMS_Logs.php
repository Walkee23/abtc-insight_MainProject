...
<style>
        ...
        .ghost-border { border: 1px solid rgba(193, 199, 211, 0.15); }
    </style>
</head>
...
<img alt="Health Worker Profile" class="w-9 h-9 rounded-full object-cover ring-2 ring-primary/10 group-hover:ring-primary/30 transition-all" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBdQ7bgUI37rYMh0UZRGlvplEN5OnophVOsoYBToEfRf1KRvYRHhpliuU4s_T6tplcPbCKQnE9P0OYn42k_FMaBXQC8QmAi3fhKGfydDGPw3jca-zjR8DtMf7ZMaR282dMFovo61GGgu_EwRkhUA9uNryJcufKlVR0l82Yy8hHnWw-vuyH-Yu_flaOpbd85R28N-upKiy7BkAenLY9YhQoikMQReTmE8EG_TF9nYXUrJF-cSfXtFU-t_bhIOis9Y4X0ucMorlAoZitm"/>
</div>
</div>
</header>
<div class="p-8">
...
<!-- PEP Completion -->
<div class="bg-surface-container-lowest p-5 rounded-lg ghost-border hover:shadow-md transition-all duration-300">
...
<p class="text-label-sm text-[10px] font-bold uppercase text-on-surface-variant tracking-widest mt-1">PEP Completion Rate</p>
</div>
<!-- SMS Success -->
<div class="bg-surface-container-lowest p-5 rounded-lg ghost-border hover:shadow-md transition-all duration-300">
<div class="flex justify-between items-start mb-4">
...
<span class="text-xs font-medium text-blue-600 bg-blue-50 px-2 py-1 rounded-full italic">Stable</span>
</div>
<p class="text-display-md text-3xl font-black text-on-surface tracking-tight">98.8%</p>
<p class="text-label-sm text-[10px] font-bold uppercase text-on-surface-variant tracking-widest mt-1">SMS Success Rate</p>
</div>
<!-- Pending Reminders -->
<div class="bg-surface-container-lowest p-5 rounded-lg ghost-border hover:shadow-md transition-all duration-300">
<div class="flex justify-between items-start mb-4">
<div class="p-2 bg-tertiary-fixed/30 rounded-lg">
<span class="material-symbols-outlined text-tertiary" data-icon="notification_important">notification_important</span>
</div>
<span class="text-xs font-bold text-on-tertiary-fixed-variant bg-tertiary-fixed px-2 py-1 rounded-full">High Priority</span>
</div>
<p class="text-display-md text-3xl font-black text-on-surface tracking-tight">42</p>
<p class="text-label-sm text-[10px] font-bold uppercase text-on-surface-variant tracking-widest mt-1">Pending Reminders</p>
</div>
<!-- Late Follow-ups -->
<div class="bg-surface-container-lowest p-5 rounded-lg ghost-border hover:shadow-md transition-all duration-300">
<div class="flex justify-between items-start mb-4">
...
<span class="text-xs font-bold text-on-error-container bg-error-container px-2 py-1 rounded-full">Critical</span>
</div>
<p class="text-display-md text-3xl font-black text-on-surface tracking-tight">18</p>
<p class="text-label-sm text-[10px] font-bold uppercase text-on-surface-variant tracking-widest mt-1">Late Follow-ups Sent</p>
</div>
</div>
...
<thead>
<tr class="text-left">
<th class="pb-4 text-[11px] font-black uppercase text-on-surface-variant tracking-widest px-2">Patient Name</th>
<th class="pb-4 text-[11px] font-black uppercase text-on-surface-variant tracking-widest px-2">Scheduled Dose</th>
<th class="pb-4 text-[11px] font-black uppercase text-on-surface-variant tracking-widest px-2">Label</th>
<th class="pb-4 text-[11px] font-black uppercase text-on-surface-variant tracking-widest px-2">Status</th>
<th class="pb-4 text-[11px] font-black uppercase text-on-surface-variant tracking-widest px-2"></th>
</tr>
</thead>
...
<td class="py-4 px-2">
<span class="text-xs bg-secondary-container text-on-secondary-container px-2 py-0.5 rounded font-semibold italic">Standard</span>
</td>
<td class="py-4 px-2">
<span class="flex items-center gap-1.5 text-xs font-bold text-on-tertiary-fixed-variant bg-tertiary-fixed px-3 py-1 rounded-full w-max">
<span class="w-1.5 h-1.5 rounded-full bg-tertiary"></span>
                                            Pending
                                        </span>
</td>
<td class="py-4 px-2 text-right">
<button class="p-1 hover:bg-surface-container-high rounded-full"><span class="material-symbols-outlined text-sm">more_vert</span></button>
</td>
</tr>
<tr class="hover:bg-surface-container-low transition-colors">
<td class="py-4 px-2">
...
<td class="py-4 px-2">
<span class="text-xs bg-blue-100 text-blue-700 px-2 py-0.5 rounded font-semibold italic">High Risk</span>
</td>
<td class="py-4 px-2">
<span class="flex items-center gap-1.5 text-xs font-bold text-green-700 bg-green-100 px-3 py-1 rounded-full w-max">
...
<td class="py-4 px-2">
<span class="text-xs bg-slate-100 text-slate-600 px-2 py-0.5 rounded font-semibold italic">Post-Exposure</span>
</td>
<td class="py-4 px-2">
<span class="flex items-center gap-1.5 text-xs font-bold text-on-error-container bg-error-container px-3 py-1 rounded-full w-max">
...
<span class="text-[10px] font-bold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full uppercase tracking-tighter">Live</span>
</div>
...
<span class="material-symbols-outlined text-xs text-green-700" data-icon="check_circle" style="font-variation-settings: 'FILL' 1;">check_circle</span>
</div>
<div class="flex-1">
...
<span class="text-[9px] font-black text-green-700 uppercase tracking-widest mt-1 block">Sent</span>
</div>
</div>
<!-- Log Item -->
...
<span class="material-symbols-outlined text-xs text-error" data-icon="error" style="font-variation-settings: 'FILL' 1;">error</span>
</div>
<div class="flex-1">
<div class="flex justify-between">
...
<span class="text-[9px] font-black text-error uppercase tracking-widest mt-1 block">Failed</span>
</div>
</div>
<!-- Log Item -->
<div class="flex items-start gap-3 p-3 rounded-lg hover:bg-surface-container-low transition-colors">
<div class="mt-1 p-1.5 bg-blue-100 rounded-full">
<span class="material-symbols-outlined text-xs text-blue-700" data-icon="pending">pending</span>
</div>
<div class="flex-1">
<div class="flex justify-between">
...
<span class="text-[9px] font-black text-blue-600 uppercase tracking-widest mt-1 block">Pending</span>
</div>
</div>
<!-- Log Item -->
<div class="flex items-start gap-3 p-3 rounded-lg hover:bg-surface-container-low transition-colors">
...
<button class="mt-6 w-full py-2.5 text-xs font-bold text-primary border border-primary/20 rounded-lg hover:bg-primary/5 transition-colors">
...
<div>
<h2 class="text-xl font-extrabold tracking-tighter text-on-surface">Compliance Performance by Barangay</h2>
<p class="text-sm text-on-surface-variant">Monthly percentage of patients completing their scheduled dose cycle</p>
</div>
<button class="px-6 py-3 bg-primary text-on-primary rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-primary/20 active:scale-95 transition-all">
...
<div class="h-full bg-gradient-to-r from-primary to-primary-container" style="width: 98%"></div>
</div>
</div>
<!-- Barangay Item -->
<div>
...
<div class="h-2 w-full bg-outline-variant/30 rounded-full overflow-hidden">
<div class="h-full bg-gradient-to-r from-primary to-primary-container" style="width: 92%"></div>
</div>
</div>
<!-- Barangay Item -->
<div>
...
<div class="h-2 w-full bg-outline-variant/30 rounded-full overflow-hidden">
<div class="h-full bg-gradient-to-r from-primary to-primary-container" style="width: 87%"></div>
</div>
</div>
<!-- Barangay Item -->
<div>
...
<div class="h-2 w-full bg-outline-variant/30 rounded-full overflow-hidden">
<div class="h-full bg-gradient-to-r from-primary to-primary-container" style="width: 95%"></div>
</div>
</div>
<!-- Barangay Item -->
<div>
...
<div class="h-2 w-full bg-outline-variant/30 rounded-full overflow-hidden">
<div class="h-full bg-gradient-to-r from-primary to-primary-container" style="width: 89%"></div>
</div>
</div>
</div>
</div>
