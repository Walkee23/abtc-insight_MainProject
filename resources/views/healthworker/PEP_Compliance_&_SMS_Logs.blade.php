...
<body class="bg-surface text-on-surface">
    ...
    <aside
        ...
        <nav class="flex-1 space-y-1">
            ...
            <!-- Compliance (ACTIVE - Target Design) -->
            <a class="flex items-center gap-3 px-4 py-3 text-blue-700 bg-white shadow-sm rounded-r-full border-l-4 border-blue-700 font-bold transition-all duration-200" href="{{ route('healthworker.compliance') }}">
                <span class="material-symbols-outlined" data-icon="verified_user">verified_user</span>
                <span class="text-sm font-['Inter']">Compliance</span>
            </a>
        </nav>
