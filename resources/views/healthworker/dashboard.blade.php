          ...
          <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-surface-container-low">
              ...
              <tr class="group hover:bg-surface/50 transition-colors">
                ...
                <td class="py-5">
                  <span class="text-xs font-medium text-slate-600 bg-slate-100 px-3 py-1 rounded-full">Returning Case
                    #2</span>
                </td>
                <td class="py-5">
                  <span
              ...
              <tr class="group hover:bg-surface/50 transition-colors">
                ...
                <td class="py-5">
                  <span class="text-xs font-medium text-slate-600 bg-slate-100 px-3 py-1 rounded-full">New
                    Exposure</span>
                </td>
                <td class="py-5">
                  <span
          ...
          <div class="space-y-4">
            ...
            <div
              ...
              <div>
                ...
                <p class="text-[11px] text-on-surface-variant leading-relaxed">Juan Gomez failed to appear for Day 7 PEP
                  dose. Immediate contact required.</p>
            ...
            <div
              ...
              <div>
                ...
                <p class="text-[11px] text-on-surface-variant leading-relaxed">RIG stock below threshold for Ward B.
                  Restock request sent to pharmacy.</p>
              </div>
            </div>
          </div>
        </div>
