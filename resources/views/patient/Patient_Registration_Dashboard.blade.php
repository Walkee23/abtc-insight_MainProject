...
<body class="bg-surface font-body text-on-surface antialiased">
  ...
  <main class="min-h-screen pt-24 pb-12 px-6 flex flex-col items-center justify-center relative overflow-hidden">
    ...
    <div class="w-full max-w-4xl text-center mb-16 relative z-10">
      <span class="inline-block px-4 py-1.5 mb-6 text-xs font-bold tracking-widest uppercase rounded-full bg-secondary-container text-on-secondary-container">
      ...
      <p class="text-lg text-on-surface-variant max-w-2xl mx-auto font-medium">
        Welcome to the digital portal for ABTC services. Please select your status below to begin your consultation process.
      </p>
    </div>
    <!-- Registration Cards Bento Grid -->
    <div class="grid md:grid-cols-2 gap-8 w-full max-w-5xl relative z-10">
      <!-- New Patient Card -->
      <div class="group bg-surface-container-lowest p-10 rounded-xl soft-shadow transition-all duration-500 hover:bg-surface-bright flex flex-col items-start text-left border border-transparent hover:border-outline-variant/10">
        <div class="mb-8 p-4 rounded-2xl bg-primary-fixed text-primary group-hover:scale-110 transition-transform duration-500">
        ...
        <p class="text-on-surface-variant leading-relaxed mb-10">
          I have never been vaccinated at CCHD-ABTC before. Select this option to create a new health record and schedule your first consultation.
        </p>
        <div class="mt-auto w-full">
          <a href="{{ route('patient.new-patient') }}" class="w-full py-4 px-6 rounded-xl bg-primary text-on-primary font-bold tracking-tight shadow-md hover:bg-primary-container hover:shadow-lg transition-all duration-300 flex items-center justify-center gap-2 group/btn">
      ...
      <div class="group bg-surface-container-lowest p-10 rounded-xl soft-shadow transition-all duration-500 hover:bg-surface-bright flex flex-col items-start text-left border border-transparent hover:border-outline-variant/10">
        <div class="mb-8 p-4 rounded-2xl bg-tertiary-fixed text-tertiary group-hover:scale-110 transition-transform duration-500">
        ...
        <!-- Updated Description -->
        <p class="text-on-surface-variant leading-relaxed mb-10">
          I already have a record at CCHD-ABTC. Use this portal if you need to report a new animal bite incident, or if you are returning to get your follow up doses (such as dose 2, 3, 4, or 5).
        </p>

        <div class="mt-auto w-full">
          <!-- Changed to an anchor tag with the returning-patient route -->
          <a href="{{ route('patient.returning-patient') }}" class="w-full py-4 px-6 rounded-xl bg-surface-container-high text-on-surface font-bold tracking-tight hover:bg-surface-variant transition-all duration-300 flex items-center justify-center gap-2 border border-outline-variant/20">
    ...
    <div class="mt-16 w-full max-w-5xl flex flex-wrap gap-4 justify-center">
      <div class="flex items-center gap-3 px-5 py-2.5 rounded-full bg-error-container text-on-error-container text-sm font-semibold">
      ...
      <div class="flex items-center gap-3 px-5 py-2.5 rounded-full bg-secondary-container text-on-secondary-container text-sm font-semibold">
    ...
    <div class="grid lg:grid-cols-2 gap-16 items-center">
      <div class="order-2 lg:order-1">
        <div class="relative rounded-xl overflow-hidden shadow-2xl">
          <img alt="Medical Facility" class="w-full h-[400px] object-cover" data-alt="Modern medical facility interior with clean glass walls, soft blue lighting, and professional medical staff in a minimalist hallway" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC0fFEvRiiSqCgM4R6WVxQn1JVnaJQiDvjYVSg8RdYCYWY0yv8fJeMifaKshlJk64Heo9QiTF0dOYVd7c1oCQkcDd6pVkPAk1I0z4qTAtIwKQ_Ehu2CPTOW1yySCQXUjT2-SR1j2A2XiCy_7IE-Z0rYdB_FWMq1nZZ1aOeO24fd2NE9Kp-GuDhQBn5bviDNNNvVrjqr5QlB-oUjkMqpWMkKmsgAw331ihhRg6e2D6UjqsAjyts42THLeQLgr3hs-P8feH03yoFzVknT" />
      ...
      <div class="order-1 lg:order-2 space-y-6">
        ...
        <p class="text-on-surface-variant text-lg font-medium leading-relaxed">
          ABTC-Insight provides real-time tracking for your vaccination schedule. Our clinical portal ensures you never miss a critical dose, providing peace of mind through automated reminders and digital certifications.
        </p>
