...
<input class="w-full bg-surface-container-highest border-none rounded-lg p-3 text-sm focus:ring-1 focus:ring-primary/20 focus:bg-surface-container-lowest transition-all" placeholder="Precinct no. / Senior Citizen ID / PWD card no." type="text"/><p class="mt-1.5 ml-1 text-[10px] text-on-surface-variant/80 italic">Required for Senior Citizens and PWDs only. Pregnant patients do not need to provide an ID number.</p>
</div>
</div>
</section>
