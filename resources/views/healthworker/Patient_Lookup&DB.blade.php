...
<body class="bg-surface text-on-surface antialiased">
  ...
  <aside
    ...
    <nav class="flex-1 space-y-1">
      ...
      <!-- Patient Database (ACTIVE - Target Design) -->
      <a class="flex items-center gap-3 px-4 py-3 text-blue-700 bg-white shadow-sm rounded-r-full border-l-4 border-blue-700 font-bold transition-all duration-200" href="{{ route('healthworker.patient-database') }}">
        <span class="material-symbols-outlined" data-icon="database">database</span>
        <span class="text-sm font-['Inter']">Patient Database</span>
      </a>
